...
int ft_printf_write(const int fd, char *str, int n);
...
int ft_printf_hex_base(const int    fd,
                       unsigned int nbr,
                       char *       charset,
                       t_convert *  convert);
int ft_printf_hex(const int fd, unsigned int nbr, t_convert *convert);
int ft_printf_hex_caps(const int fd, unsigned int nbr, t_convert *convert);
