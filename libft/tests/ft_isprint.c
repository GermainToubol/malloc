...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/20 20:10:37 by gtoubol           #+#    #+#             */
/*   Updated: 2022/12/20 20:10:37 by gtoubol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <ctype.h>
#include <stdio.h>
...
static int	correctness(void)
{
	...
	while (i < 256)
	{
		if (isprint(i) != 16384 * ft_isprint(i))
		{
			printf("isprint: KO [%d] libc[%d] ft[%d]\n",
...
static void	timecmp(void)
{
	...
	std = getdelay(isprint);
	ft = getdelay(ft_isprint);
