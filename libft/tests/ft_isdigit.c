...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/20 19:18:58 by gtoubol           #+#    #+#             */
/*   Updated: 2022/12/20 19:18:58 by gtoubol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	correctness(void)
{
	...
	while (i < 256)
	{
		if (isdigit(i) != 2048 * ft_isdigit(i))
		{
			printf("isdigit: KO [%d] libc[%d] ft[%d]\n",
...
static void	timecmp(void)
{
	...
	std = getdelay(isdigit);
	ft = getdelay(ft_isdigit);
