...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/20 19:57:16 by gtoubol           #+#    #+#             */
/*   Updated: 2022/12/20 19:57:16 by gtoubol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	correctness(void)
{
	...
	while (i < 256)
	{
		...
		{
			printf("isascii: KO [%d] libc[%d] ft[%d]\n",
...
static void	timecmp(void)
{
	...
	std = getdelay(isascii);
	ft = getdelay(ft_isascii);
